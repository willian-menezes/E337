...
const MainTabs = createBottomTabNavigator(
  {
    Notifications: {
      ...
      navigationOptions: {
        ...
        tabBarIcon: ({tintColor}) => <Notifications color={`${tintColor}`} />,
      },
    },
    Home: {
      screen: HomeStack,
      navigationOptions: {
        tabBarLabel: 'HOME',
        tabBarIcon: ({tintColor}) => <Heart color={`${tintColor}`} />,
      },
    },
    Events: {
      screen: Oracoes,
      navigationOptions: {
        tabBarLabel: 'Events',
        tabBarIcon: ({tintColor}) => <Events color={`${tintColor}`} />,
      },
    },
  },
  {
...
const createRoutes = ({customRoutes}: TCreateRoutesOptions) =>
  createAppContainer(
